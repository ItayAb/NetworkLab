...
//	private SynchronousQueue<HTML> m_AnalyzeQueue;
	...
	public Downloader(ConfigData configurationData, SynchronizedQueue<String> m_UrlQueue, SynchronizedQueue<HTML> m_HtmlQueue, String Domain, int port) {
	...
	public void run() {
		...
		while (ThreadManager.isRunning){//m_DownloadQueue.getSize() > 0 || m_AnalyzeQueue.getSize() > 0) { // TODO: think of a better condition
